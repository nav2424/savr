...
export default {
  expo: {
    ...
    extra: { 
      ...
      EXPO_PUBLIC_RC_TEST_STORE_API_KEY: process.env.EXPO_PUBLIC_RC_TEST_STORE_API_KEY || process.env.EXPO_PUBLIC_REVENUECAT_TEST_STORE_API_KEY || process.env.EXPO_PUBLIC_REVENUECAT_WEB_API_KEY,
      EXPO_PUBLIC_REVENUECAT_TEST_STORE_API_KEY: process.env.EXPO_PUBLIC_REVENUECAT_TEST_STORE_API_KEY || process.env.EXPO_PUBLIC_RC_TEST_STORE_API_KEY || process.env.EXPO_PUBLIC_REVENUECAT_WEB_API_KEY,
      EXPO_PUBLIC_REVENUECAT_OFFERING_ID: process.env.EXPO_PUBLIC_REVENUECAT_OFFERING_ID,
      EXPO_PUBLIC_REVENUECAT_ENTITLEMENT_ID: process.env.EXPO_PUBLIC_REVENUECAT_ENTITLEMENT_ID || process.env.EXPO_PUBLIC_RC_ENTITLEMENT_ID,
      EXPO_PUBLIC_RC_ENTITLEMENT_ID: process.env.EXPO_PUBLIC_RC_ENTITLEMENT_ID || process.env.EXPO_PUBLIC_REVENUECAT_ENTITLEMENT_ID,
      eas: {
